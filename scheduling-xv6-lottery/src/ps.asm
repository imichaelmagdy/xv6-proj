   ...
   7:	31 c0                	xor    %eax,%eax
{
  ...
  12:	51                   	push   %ecx
  struct pstat pinfo = {0};
  13:	8d bd e8 fb ff ff    	lea    -0x418(%ebp),%edi
  if (getpinfo(&pinfo) == 0){
  19:	8d 9d e8 fb ff ff    	lea    -0x418(%ebp),%ebx
  struct pstat pinfo = {0};
  1f:	b9 00 01 00 00       	mov    $0x100,%ecx
{
  24:	81 ec 14 04 00 00    	sub    $0x414,%esp
  struct pstat pinfo = {0};
  2a:	f3 ab                	rep stos %eax,%es:(%edi)
  if (getpinfo(&pinfo) == 0){
  2c:	53                   	push   %ebx
  2d:	e8 68 03 00 00       	call   39a <getpinfo>
  32:	83 c4 10             	add    $0x10,%esp
  35:	85 c0                	test   %eax,%eax
  37:	74 05                	je     3e <main+0x3e>
		pinfo.ticks[i]
		);
      }
    }
  ...
  exit();
  39:	e8 b4 02 00 00       	call   2f2 <exit>
    printf(1, "PID\t|\tUSED?\t|\tTickets\t|\tTicks\n");
  3e:	50                   	push   %eax
  3f:	50                   	push   %eax
  40:	8d b5 e8 fc ff ff    	lea    -0x318(%ebp),%esi
  ...
  58:	8b 83 00 02 00 00    	mov    0x200(%ebx),%eax
  5e:	8b 93 00 03 00 00    	mov    0x300(%ebx),%edx
  64:	85 c0                	test   %eax,%eax
  66:	75 04                	jne    6c <main+0x6c>
  68:	85 d2                	test   %edx,%edx
  6a:	74 1c                	je     88 <main+0x88>
        printf(1, "%d\t|\t%d\t|\t%d\t|\t%d\n",
  6c:	83 ec 08             	sub    $0x8,%esp
  6f:	52                   	push   %edx
  70:	ff b3 00 01 00 00    	pushl  0x100(%ebx)
  76:	ff 33                	pushl  (%ebx)
  78:	50                   	push   %eax
  79:	68 c8 07 00 00       	push   $0x7c8
  7e:	6a 01                	push   $0x1
  80:	e8 cb 03 00 00       	call   450 <printf>
  85:	83 c4 20             	add    $0x20,%esp
  88:	83 c3 04             	add    $0x4,%ebx
    for(i=0;i<NPROC;i++){
  8b:	39 f3                	cmp    %esi,%ebx
  8d:	75 c9                	jne    58 <main+0x58>
  8f:	eb a8                	jmp    39 <main+0x39>
  91:	66 90                	xchg   %ax,%ax
  93:	66 90                	xchg   %ax,%ax
  95:	66 90                	xchg   %ax,%ax
  97:	66 90                	xchg   %ax,%ax
