...
int main(void)
{
  ...
  12:	6a 01                	push   $0x1
  14:	e8 51 03 00 00       	call   36a <sbrk>
  ...
  2a:	83 c4 18             	add    $0x18,%esp
  2d:	68 bc 07 00 00       	push   $0x7bc
  32:	6a 01                	push   $0x1
  34:	e8 07 04 00 00       	call   440 <printf>
  *p =100;
  39:	c7 03 64 00 00 00    	movl   $0x64,(%ebx)
  ...
  4e:	83 c4 18             	add    $0x18,%esp
  51:	6a 04                	push   $0x4
  53:	53                   	push   %ebx
  54:	e8 29 03 00 00       	call   382 <mprotect>
  printf(1, "Used mprotect(), trying to overwrite with value 200...\n");
  59:	58                   	pop    %eax
  5a:	5a                   	pop    %edx
  5b:	68 10 08 00 00       	push   $0x810
  60:	6a 01                	push   $0x1
  62:	e8 d9 03 00 00       	call   440 <printf>
  *p =200;
  67:	c7 03 c8 00 00 00    	movl   $0xc8,(%ebx)
  printf(1, "COMPLETED! memory location %p contents: %d\n", p, *p);
  6d:	68 c8 00 00 00       	push   $0xc8
  72:	53                   	push   %ebx
  73:	68 e4 07 00 00       	push   $0x7e4
  78:	6a 01                	push   $0x1
  7a:	e8 c1 03 00 00       	call   440 <printf>
  exit();
 ...
 3a9:	85 d2                	test   %edx,%edx
{
 ...
 3d7:	f7 f1                	div    %ecx
 3d9:	0f b6 92 50 08 00 00 	movzbl 0x850(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb 48 08 00 00       	mov    $0x848,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 f8 0a 00 00       	mov    0xaf8,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 f8 0a 00 00       	mov    %eax,0xaf8
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 f8 0a 00 00       	mov    %eax,0xaf8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 f8 0a 00 00    	mov    0xaf8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 f8 0a 00 00    	cmp    %eax,0xaf8
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 f8 0a 00 00    	mov    0xaf8,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 f8 0a 00 00    	mov    %edx,0xaf8
}
 ...
 759:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 f8 0a 00 00 fc 	movl   $0xafc,0xaf8
 767:	0a 00 00 
 76a:	c7 05 fc 0a 00 00 fc 	movl   $0xafc,0xafc
 771:	0a 00 00 
    base.s.size = 0;
 774:	b8 fc 0a 00 00       	mov    $0xafc,%eax
 779:	c7 05 00 0b 00 00 00 	movl   $0x0,0xb00
 780:	00 00 00 
