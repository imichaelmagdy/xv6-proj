 ...
 591:	a1 bc 09 00 00       	mov    0x9bc,%eax
{
 ...
 5cd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5cf:	a3 bc 09 00 00       	mov    %eax,0x9bc
}
 5d4:	5b                   	pop    %ebx
 5d5:	5e                   	pop    %esi
 5d6:	5f                   	pop    %edi
 ...
 5e6:	72 ce                	jb     5b6 <free+0x26>
{
 ...
 607:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 60a:	a3 bc 09 00 00       	mov    %eax,0x9bc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 66f:	73 47                	jae    6b8 <malloc+0x98>
    ...
    if(p == freep)
 671:	39 05 bc 09 00 00    	cmp    %eax,0x9bc
 ...
 696:	e8 f5 fe ff ff       	call   590 <free>
  return freep;
 69b:	8b 15 bc 09 00 00    	mov    0x9bc,%edx
 ...
 6c4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6c7:	89 15 bc 09 00 00    	mov    %edx,0x9bc
}
 ...
 6d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 6e0:	c7 05 bc 09 00 00 c0 	movl   $0x9c0,0x9bc
 6e7:	09 00 00 
 6ea:	c7 05 c0 09 00 00 c0 	movl   $0x9c0,0x9c0
 6f1:	09 00 00 
    base.s.size = 0;
 6f4:	b8 c0 09 00 00       	mov    $0x9c0,%eax
 6f9:	c7 05 c4 09 00 00 00 	movl   $0x0,0x9c4
 700:	00 00 00 
