...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 72 56 10 80 	movl   $0x80105672,0x14(%eax)
  p->context = (struct context*)sp;
...
8010484f:	8b 70 1c             	mov    0x1c(%eax),%esi
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104852:	8d 46 ff             	lea    -0x1(%esi),%eax
80104855:	83 f8 15             	cmp    $0x15,%eax
80104858:	77 36                	ja     80104890 <syscall+0x50>
8010485a:	8b 04 b5 c0 75 10 80 	mov    -0x7fef8a40(,%esi,4),%eax
80104861:	85 c0                	test   %eax,%eax
80104863:	74 2b                	je     80104890 <syscall+0x50>
    curproc->tf->eax = syscalls[num]();
80104865:	ff d0                	call   *%eax
80104867:	8b 53 18             	mov    0x18(%ebx),%edx
    if (num == 5) {
8010486a:	83 fe 05             	cmp    $0x5,%esi
    curproc->tf->eax = syscalls[num]();
8010486d:	89 42 1c             	mov    %eax,0x1c(%edx)
    if (num == 5) {
80104870:	74 0e                	je     80104880 <syscall+0x40>
  } else {
...
80104879:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        readcount++;
80104880:	83 05 bc a5 10 80 01 	addl   $0x1,0x8010a5bc
}
...
8010488e:	66 90                	xchg   %ax,%ax
            curproc->pid, curproc->name, num);
80104890:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
...
801054a1:	a1 bc a5 10 80       	mov    0x8010a5bc,%eax
{
...
801055f5:	e8 06 ee ff ff       	call   80104400 <release>
      return -1;
...
80105618:	e8 e3 ed ff ff       	call   80104400 <release>
  return 0;
...
8010564e:	e8 ad ed ff ff       	call   80104400 <release>
  return xticks;
}
...
8010584d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105850:	e8 eb ef ff ff       	call   80104840 <syscall>
    if(myproc()->killed)
